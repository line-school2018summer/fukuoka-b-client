 ...
 * [ChannelSettingUserFragment.OnListFragmentInteractionListener] interface.
 */
class ChannelSettingUserFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            users = item_array.toList() as List<UserDTO>
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_channelsettinguser_list, container, false)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(columnCount: Int, users: List<UserDTO>) =
                ChannelSettingUserFragment().apply {
                    arguments = Bundle().apply {
                        putInt(ARG_COLUMN_COUNT, columnCount)
                        putParcelableArray(ARG_ITEMS, users.toTypedArray())
                    }
                }
    }
}
